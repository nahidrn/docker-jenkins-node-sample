...
const linkToExecutor = (link) => ({ document, variables, context, info, }) => utils.toPromise(core.execute(link, {
    query: document,
    variables,
    context: {
...
const linkToSubscriber = (link) => async ({ document, variables, context, info, }) => utils$1.observableToAsyncIterable(core.execute(link, {
    query: document,
    variables,
    context: {
        graphqlContext: context,
